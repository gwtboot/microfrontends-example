...
import static com.example.platform.client.ui.PlatformClientBundle.BUNDLE;
...
import com.example.platform.client.ui.TodoItem.Priority;

import elemental2.dom.HTMLDivElement;

public class PlatformView implements IsElement<HTMLDivElement> {

	private static Logger logger = Logger.getLogger(PlatformView.class.getName());
